...
function verificaMotivo(motivo){
	...
	//Criamos um nó de texto "Freezer" e gravamos na variáveç 'texto'
	var texto = document.createTextNode("Freezer");
	//Colocamos o nó de texto criado como "filho" na tag option criada
	option.appendChild(texto);
	//Conteúdo atual da variável option:
	...
	//Colocamos o option criado como "filho" da tag select criada
	select.appendChild(option);
	//Conteúdp atual da variável select:
	/*
	...
	*/
	...
	//Criamos um nó de texto "Geladeira" e gravamos na variáveç 'texto'
